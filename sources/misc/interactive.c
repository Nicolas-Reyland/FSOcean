...
#define FLAG_LITERAL_LENGTH 100

static char FLAGS[]
                 [FLAG_LITERAL_LENGTH] = {
                     {
                         'T', 'L', 'C', 0,   1,   'T', 'o', 'k', 'e', 'n', 's',
                         ' ', 'L', 'e', 'x', 'i', 'c', 'a', 'l', ' ', 'C', 'o',
                         'n', 'v', 'e', 'n', 't', 'i', 'o', 'n', 's', 0,
                     ...
                     {'A', 'E', 'X', 'E', 0,   1,   'A', 'b', 's', 't',
                      'r', 'a', 'c', 't', ' ', 'E', 'x', 'e', 'c', 'u',
                      't', 'a', 'b', 'l', 'e', 's', 0}, // Abstract Executables
};
...
static Token *tokenize_with_flags(char buffer[256], size_t line_len,
                                  size_t *num_tokens);
...
static Token *tokenize_with_flags(char buffer[MAX_LINE_LENGTH], size_t line_len,
                                  size_t *num_tokens) {
